...
good_pointer = Rect(
    ...
    y=0,
    width=10,
    height=int(((CO2_POOR - CO2_GOOD) / CO2_MAXIMUM) * HEIGHT) + 1,
    fill=GREEN,
    outline=BLACK,
    stroke=1,
)
...
poor_pointer = Rect(
    ...
    y=0,
    width=10,
    height=int(((CO2_WARNING - CO2_POOR) / CO2_MAXIMUM) * HEIGHT) + 0,
    fill=YELLOW,
    outline=BLACK,
    stroke=1,
)
...
warning_pointer = Rect(
    ...
    y=0,
    width=10,
    height=int(((CO2_DANGER - CO2_WARNING) / CO2_MAXIMUM) * HEIGHT) + 0,
    fill=ORANGE,
    outline=BLACK,
    stroke=1,
)
...
danger_pointer = Rect(
    ...
    y=0,
    width=10,
    height=int(((CO2_MAXIMUM - CO2_DANGER) / CO2_MAXIMUM) * HEIGHT) + 1,
    fill=RED,
    outline=BLACK,
    stroke=1,
)
